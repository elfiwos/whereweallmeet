    ...
    <?php echo Form::open('browse/browse_members'); ?>
        <section id="quick-search">
            ...
            <div class="quick-search">
                ...
                <div class="full-section">
                    ...
                    <input type="text" name="keywords" size="90" placeholder="Search by username or email" value="<?php if (isset($keyword)) echo $keyword; ?>"/>
        ...
        <section class="browse-members">
            <div class="inner-wrapper">
                ...
                <div id="quick"> <h2>Browsing Where We All Meet Members</h2> </div>
