...
function get_event_types()
{
    ...
    $option['Jazz Concert'] = 'Jazz Concert';
    $option['Basketball Match'] = 'Basketball Match';
    $option['Music Concert'] = 'Music Concert';
    $option['Fashion Show'] = 'Fashion Show';
    $option['Other'] = 'Other';
    return $option;
}
    ...
    <div id="main-content">
        <?php if($identifier == 0): ?>
           ...
           <div id="common-content">
            <?php echo \Fuel\Core\Form::open(array('action' => 'admin/event_plan','enctype'=>'multipart/form-data')); ?>
                <?php if(isset($errors)): ?>
           ...
           <div id = "long-description">
            ...
            <div id="type">
                ...
                <?php echo \Fuel\Core\Form::select('type',null, get_event_types(),array('id'=>'event_type'))?>
            </div>
        ...
        <?php if($identifier == 1): ?>
           ...
           <div id="common-content">
            <?php echo \Fuel\Core\Form::open(array('action' => 'admin/edit_events','enctype'=>'multipart/form-data')); ?>
            <?php if(isset($errors)): ?>
                <?php foreach ($errors as $field => $error): ?>
                    <?php echo $error->get_message().'<br>'; ?>
                <?php endforeach; ?>
            ...
            <div id="event-description-container" class="clearfix">
               ...
               <div id="type">
                   <label for="type">Type:</label>
                   <?php echo \Fuel\Core\Form::select('type',$editevents->type, get_event_types(),array('id'=>'event_type'))?>
               </div>
               ...
               <div id="address">
                   <label for="venue">Youtube Video:</label>
                   <?php echo \Fuel\Core\Form::input('youtube_video',$editevents->youtube_video, array('size'=>'120'))?>
               </div>
            ...
            <div id="featured">
                <label for="end_time_hour">Featured</label>
                <?php echo \Fuel\Core\Form::checkbox('is_featured', $editevents->is_featured, ($editevents->is_featured == 1? true: false),array('id'=>'feature-box')) ?>
            </div>
