...
<div id="content" class="clearfix">
    <div class="sub-nav">
        <ul  class="nav nav-pills">
            ...
            <li><?php echo \Fuel\Core\Html::anchor('admin/dating_packages', 'Date Ideas',array('class' => 'active-link')) ?></li>
    ...
    <?php if($identifier == 0): ?>
     <div id="sub-content">
         <div id="common-content">
            <?php echo \Fuel\Core\Form::open(array('action' => 'admin/dating_packages',"enctype" => "multipart/form-data")); ?>
                <?php if(isset($errors)): ?>
        ...
        <div id="sub-content">
            <div id="common-content">
                <?php echo \Fuel\Core\Form::open(array('action' => 'admin/edit_packages',"enctype" => "multipart/form-data")); ?>
                <?php if(isset($errors)): ?>
                    <?php foreach ($errors as $field => $error): ?>
                        <?php echo $error->get_message().'<br>'; ?>
                    <?php endforeach; ?>
          ...
          <div id = "headers">
            ...
            <div id = "event-container">
             ...
             <div id = "delete-button">
              ...
              <?php echo Form::close();?>
             <?php else: ?>
            <p class="nodata-message">There are no created date ideas.</p>
             <?php endif; ?> 
            </div>
         </div>
