<div id="content" class="clearfix">
    <div class="inner-wrapper">
        <div class="section-title">
            <h3>GetAway Search Result</h3>
            <div class="getaway-icon"></div>
            <div class="clearfix"></div>
        </div>

        <div id="middle">
            <?php if (isset($getaways) and $getaways !== false): ?>
                ...
                <?php if(count($getaways)> 10): ?>
                    <div class="btn-holder">
                        <a class="more-events" data-count="<?php echo count($getaways); ?>" href="#">More Get-Aways</a>
                    </div>
                <?php endif; ?>
            <?php else: ?>
                <div class="event-list clearfix" id="no-event">
                    No getaway found for your search.
                </div>
            <?php endif; ?>
