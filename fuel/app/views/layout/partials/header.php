        ...
        <?php if(isset($current_profile)): ?>
            <div id="top-nav-container" class="clearfix">
                ...
                <div>
					...
					<p class="notification"><?php echo $countnewmessage;?></p>
                </div>

                <div>
                    <?php echo Html::anchor(Uri::create("profile/friend_request"), '<span>Request</span>'. Asset::img("my_friend_request_icon.png")); ?>
					<p class="notification"><?php echo $countfriendrequest ;?></p>
                </div>
                <div id="round-profile-pic-container">
                    <?php echo Html::anchor(Uri::create("profile/my_setting"), Html::img(Model_Profile::get_picture($current_profile->picture, $current_profile->user_id, "members_list")) . '<span>'. $current_user->username . '</span>'); ?>
                </div>
            </div>
        <?php endif; ?>
    </div>
