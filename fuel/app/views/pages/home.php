...
<div class="wrapper">
    ...
    <div id="login-section" class="clearfix">
        <div id="top-section-content" class="clearfix" >
            <div id="left-content">
<!--                <p><a target="blank" href="#">Contact Us</a></p>-->
<!--                <p>|</p>-->
<!--                <p><a target="blank" href="http://whereweallmeet.com/blog/">Blog</a></p>-->
            ...
            <div id="login-container" class="clearfix">
                ...
                <div id="login-label" class="form-group">Already a Member?</div>
    ...
    <div id="top-section" class="clearfix">
        <div id="top-section-content" class="clearfix">
            ...
            <div id="company-identity-container" class="clearfix">
                <h3><span class="black">The New Place to...</span><span class="blue">Connect,</span> Share <span class="purple">Experiences,</span> and <span class="green">Explore</span> Dating <span class="yellow">Ideas</span> </h3>
            </div>
    ...
    <div id="our-services-container" >
        <div id="slideshow">
            <?php echo Asset::img('pages/home2/header-bg-1.jpg', array('class' => 'slideshow-image')); ?>
            <?php echo Asset::img('pages/home2/header-bg-2.jpg', array('class' => 'slideshow-image')); ?>
            <?php echo Asset::img('pages/home2/header-bg-3.jpg', array('class' => 'slideshow-image')); ?>
            <?php echo Asset::img('pages/home2/header-bg-4.jpg', array('class' => 'slideshow-image')); ?>
            <?php echo Asset::img('pages/home2/header-bg-5.jpg', array('class' => 'slideshow-image')); ?>
        </div>
    </div>
    <div id="signup-container" class="clearfix">
        <div id="signup-content" class="clearfix">
            ...
            <div id="right-section-content" class="clearfix">
                <h3 id="registration-text">
                    Meet <span>SOMEONE NEW</span> today, Get <span>STARTED NOW</span>!
                </h3>
                <?php echo Form::open(array("action" => "users/sign_up", "class" => "")) ?>
                    ...
                    <div id="signup-container" class="clearfix">
                        <button id="step_zero" type="button" data-dialog="create_account">Sign Up Now</button>
                        <?php echo Html::anchor(Uri::create("users/m_sign_up"), "Sign Up Now", array("id"=>"m-signup-link")); ?>
                    </div>
                <?php echo Form::close();?>
            </div>

            <div id="welcome-message-container" class="clearfix">
                <h3>Welcome to WhereWeAllMeet</h3>
                <p>The world’s newest platform for online dating, exclusive event booking, real-time dating concierge, and vacation get-away packages. With our innovative web software features, WhereWeAllMeet gives you the ability to connect with people no matter where you are. Sit back and connect while our WhereWeAllMeet team provides you with a varity of dating ideas, group events, and vacation packages that are guaranteed to bring some fun and excitement into your life. </p>
            </div>
        </div>
    ...
    <div id="get-started-container" class="clearfix">
        ...
        <div id="get-started-content">
            <h1><span>Experience WhereWeAllMeet</span></h1>
...
<div class="modal-container get-info-modals" id="step_nine_dialog">
    ...
    <?php echo Form::open(array("id" => "signup_form","action" => "users/sign_up", "enctype" => "multipart/form-data")) ?>
            <div class="modal-body">
                ...
                <div class="floating-container" style="background-color: transparent">
                    ...
                    <div class="row">
                      ...
                      <input name = "seeking_height" type = "hidden" id = "info39">
                      ...
                      <input name = "seeking_occupation_id" type = "hidden" id = "info48">
                    <input name="facebook_profile" type="hidden" id="info49">



                        </div>
                        <div class="col upload-box" style="background-color:#fff">
                            <?php echo Asset::img('pages/home2/upload-fb.png', array('id' => 'facebook_profile')); ?>
                            <div class="clearfix">
                                <button onclick="myFacebookLogin()" type="button">From Facebook</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="floating-container">
                    ...
                    <div class="row">
                        ...
                        <div class="col col-md-9 full-width">
                            <select name="seeking_education" id="seeking_education">
                                <option value="">Select Their Education</option>
                    ...
                    <div class="row">
                        <div class="col col-md-3">Occupation</div>
                        <div class="col col-md-9 full-width">
                            <select name="seeking_occupation" id="seeking_occupation">
                                <option value="">Select Their Occupation</option>
                                <?php foreach ($occupations as $occupation):?>
                                <option value="<?php echo $occupation['id'] ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col col-md-9 half-width">
                            <select name="seeking_ethnicity" id="seeking_ethnicity">
                                <option value="">Select Their Ethnicity</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col col-md-9 half-width">
                            <select name="seeking_faith" id="seeking_faith">
                                <option value="">Select Their Faith</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col col-md-9 full-width">
                            <select name="seeking_children" id="seeking_children">
                                <option value="">Do They Have Children?</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col col-md-9 half-width">
                            <select id="seeking_height" name="seeking_height">
                                <option value=""></option>
                                <option>4'11" to 5'3"</option>
                                <option>5'4" to 5'7"</option>
                                <option>5'8" to 6'0"</option>
                                <option>6'1" to 6'4"</option>
                                <option>6'5" to 6'9"</option>
                                <option>6'10" to 7'0"</option>
                                <option>7'1" to +</option>
                            </select>
                        </div>
                    </div> 
                    ...
                    <div class="row">
                        ...
                        <div class="col col-md-9 half-width">
                            <select name="seeking_politics" id="seeking_politics">
                                <option value="">Select Their Politics</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col col-md-9 full-width">
                            <select name="seeking_exercise" id="seeking_exercise">
                                <option value="">How Often Do They Exercise?</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col col-md-9 full-width">
                            ...
                            <option value="" selected>Select Their Body Type</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col col-md-9 full-width">
                            <select name="seeking_drink" id="seeking_drink">
                                <option value="0">How Often Do They Drink?</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col col-md-9 full-width">
                            <select name="seeking_smoke" id="seeking_smoke">
                                <option value="">How Often Do They Smoke?</option>
            ...
            <div class="modal-body modal-privacy">
                <div class="row">
                    ...
                    <div class="col col-md-5 account-form">
                        ...
                        <span class="purple"><a target="_blank" href="http://whereweallmeet.com/blog/terms/">Terms of Use</a></span>
                        and the <span class="purple"><a target="_blank" href="http://whereweallmeet.com/blog/privacy/">Privacy Policy</a>
                        </span></strong></p>
                    </div>
            </div>
