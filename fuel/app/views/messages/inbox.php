                 ...
                 <?php if($profile): ?>
                    <div id="<?php echo "message-container-" . $message->id; ?>" class="message">
                        ...
                        <div class="pull-left full-message">
                            <p class="message-subject"><?php echo Html::anchor(Uri::create('message/message_detail/'.$message->id), $message->subject, array("id" => "message-link")); ?></p>
                            <p class="gray"><?php echo Str::truncate($message->body, 20); ?></p><br/><br/>
                        ...
                        <div class="pull-right message-date">
                            ...
                            <div class="message-del">
                                <?php echo Html::anchor("#", "X", array("class" => "", "data-action" => Uri::create('message/delete_message'), "data-message-container" => "message-container-" . $message->id, "data-message-id" => $message->id, "data-message-section" => "inbox")); ?>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
