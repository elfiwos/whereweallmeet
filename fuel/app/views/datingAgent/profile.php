    ...
    <div id="middle" class="agent-profile-middle">
        <section class="agent-listing agent-profile-page">
          <div class="header-section">
              <p class="header-text">Current Clients</p>
          </div>
            
            <div class="content">
                <div>
                    <?php echo Html::anchor(Uri::create("agent/manage_clients"), "Manage Clients",array('id'=>'manage-clients-link', 'class' => 'blue-btn')); ?>
                </div>
                    ...
                    <?php foreach($clients as $client): ?>
                        <?php if( ! Model_Profile::is_deleted_account($client->id)): ?>
                            ...
                            <div class="agent">
                                ...
                                <div class="agent-image"><?php echo View::forge("profile/partials/member_agent_client_thumb", array("member" => $client)); ?></div>
                            </div>
                        <?php endif; ?>
                    <?php endforeach; ?>
                <?php endif; ?>
